...
const Users: React.FC = () => {
  ...
  const handleResetPassword = async () => {
    ...
    try {
      ...
      toast.success(
        `E-mail de redefinição de senha enviado para ${selectedUser.email}`
      );
    } catch (error) {
      console.error("Erro:", error);
  ...
  const handleRoleChange = async () => {
    ...
    try {
      ...
      toast.success(
        `Papel do usuário alterado para ${
          newRole === "sindico" ? "Síndico" : "Morador"
        }`
      );
    } catch (error) {
      console.error("Erro:", error);
  ...
  return (
    <PageLayout
      title="Usuários"
      subtitle="Gerencie os moradores e administradores do condomínio"
      headerActions={
        <Button
          variant="outline"
                  ...
                  <div className="flex items-center justify-between space-x-2">
                    ...
                    >
                      ...
                      <span className="font-normal text-xs text-gray-500">
                        Permite que o usuário tenha acesso a todas as funções
                        administrativas
                      </span>
                    </Label>
                    <Switch
